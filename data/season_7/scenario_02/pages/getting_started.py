from src.ReadAloudModel import ReadAloud
from src.SkillCheckModel import SkillCheck
from src.SubsectionHeaderModel import SubsectionHeader
...
def getting_started():
    ...
    SkillCheck("Recall Knowledge on wine.",
                    [
