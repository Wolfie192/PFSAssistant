...
from src.VariableModel import Variable
...
def gorilla_warfare():
    ...
    if st.session_state["tier"] == "Low" and st.session_state["challenge_points"] <= 9:
        CombatEncounterModel(
            ...
            [
                Monster("Pirate Goblin"),
                Monster("Pirate Goblin"),
                Monster("Pirate Gorilla")
        ...
        CombatEncounterModel(
            ...
            [
                Monster("Goblin Rigger"),
                Monster("King Pirate Gorilla")
